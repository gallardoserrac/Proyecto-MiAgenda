...
let calendarioGrid, tituloCalendario, prev, next, fechaMinima, fechaActual, tareas;

function init() {
  calendarioGrid = document.getElementById("calendario-grid");
  tituloCalendario = document.getElementById("titulo-calendario");
  prev = document.getElementById("prev");
  next = document.getElementById("next");
  fechaMinima = new Date(2026, 0, 1);
  fechaActual = new Date(2026, 0, 1);
  tareas = {};
