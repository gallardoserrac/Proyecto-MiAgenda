...
<body>
  <header>
    <div class="brand">MiAgenda <small>| Kanban</small></div>
    <div style="font-size:12px;color:#666;">arrastrar y soltar · editable · autosave</div>
    <a href="index.php" style="color:#111;text-decoration:none;">← Volver</a>
  </header>
  <div class="kanban">
    <div class="col" data-col="pendiente">
      <h3>Por hacer</h3>
      <div class="top"><span></span><button class="add">+ Añadir</button></div>
      <div class="zona" id="suelta-1"></div>
    </div>
    <div class="col" data-col="en_progreso">
      <h3>En curso</h3>
      <div class="top"><span></span><button class="add">+ Añadir</button></div>
      <div class="zona" id="suelta-2"></div>
    </div>
    <div class="col" data-col="en_revision">
      <h3>En revisión</h3>
      <div class="top"><span></span><button class="add">+ Añadir</button></div>
      <div class="zona" id="suelta-3"></div>
    </div>
    <div class="col" data-col="completado">
      <h3>Hecho</h3>
      <div class="top"><span></span><button class="add">+ Añadir</button></div>
